                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        InkWell(
                          onTap: () {
                            final manager = GlobalVideoPlayerManager();
    if (manager.isInitialized) {
      // Video is already playing, navigate to CustomVideoPlayerScreen
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => CustomVideoPlayerScreen(videoUrl: manager.controller.dataSource),
        ),
      );
    } else {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => CustomVideoPlayerScreen(videoUrl: "https://www.w3schools.com/html/mov_bbb.mp4"),
        ),
      );
    }
